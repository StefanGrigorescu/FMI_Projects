...
-- ex 7: Creati o procedură care primeste ca parametru de intrare codul unei livrări si îi setează status_livrare ca 'sosita', 
-- iar pentru fiecare produs care are cod_livrare egal cu parametrul dat, setează cod_livrare cu NULL si cod_magazin 
