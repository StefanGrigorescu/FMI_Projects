...
import com.example.notebook.api.IdentityApi
import com.example.notebook.api.IdentityApiSpecification
...
val appModule = module {
    factory(named(IdentityApiSpecification.name)) {
        Retrofit.Builder()
            .baseUrl(IdentityApiSpecification.Routes.root)
