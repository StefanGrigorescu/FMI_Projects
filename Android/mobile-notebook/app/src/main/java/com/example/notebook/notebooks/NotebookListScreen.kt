...
import com.example.notebook.settings.Preferences
...
fun NotebookListScreen(
    ...
    val savedSortingOption = preferences.check("Notebooks default sorting option") ?: "Title"
    viewModel.onEvent(NotebooksEvent.SortNotebooksEvent(notebooksSortByFromName(savedSortingOption)))
